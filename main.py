...
if __name__ == '__main__':
    pygame.mixer.init()
    pygame.mixer.music.load("media/Till-i-found-you1.mp3")
    pygame.mixer.music.play(-1)  # -1 表示循环播放
    root = Tk()
    root.title("made by Hobin")
    ...
    # 创建视频播放器
    video_player = VideoPlayer("media/fire4.mp4", CANVAS_WIDTH, CANVAS_HEIGHT)
    # video_player = VideoPlayer("./sea-fire.mp4", CANVAS_WIDTH, CANVAS_HEIGHT)
